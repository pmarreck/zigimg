...
test "TIFF/BE 24-bit uncompressed RGB with replicated BitsPerSample and missing StripByteCounts" {
    ...
    var the_tiff = tiff.TIFF{};
    var read_stream = zigimg.io.ReadStream.initMemory(@embedFile("../fixtures/tiff/sample-rgb24-bps1-no-stripbc.tiff"));
...
test "TIFF/BE monochrome CCITT Group 4 (T.6) - all white" {
    var the_tiff = tiff.TIFF{};
    var read_stream = zigimg.io.ReadStream.initMemory(@embedFile("../fixtures/tiff/sample-monob-ccitt-g4-white.tiff"));
...
test "TIFF/BE monochrome CCITT Group 4 (T.6) - all black" {
    var the_tiff = tiff.TIFF{};
    var read_stream = zigimg.io.ReadStream.initMemory(@embedFile("../fixtures/tiff/sample-monob-ccitt-g4-black.tiff"));
...
test "TIFF/BE monochrome CCITT Group 4 (T.6) - vertical stripe pattern" {
    var the_tiff = tiff.TIFF{};
    var read_stream = zigimg.io.ReadStream.initMemory(@embedFile("../fixtures/tiff/sample-monob-ccitt-g4-pattern.tiff"));
...
test "TIFF/BE monochrome CCITT Group 4 (T.6) - mixed checkerboard halves" {
    var the_tiff = tiff.TIFF{};
    var read_stream = zigimg.io.ReadStream.initMemory(@embedFile("../fixtures/tiff/sample-monob-ccitt-g4-mixed.tiff"));
